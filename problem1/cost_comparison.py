...
"""
    output_file = "cost_comparison.md"
    with open(output_file, "w", encoding="utf-8") as f:
        f.write(content)
    
    print(f"Successfully generated {output_file}")
    print("\n--- Cost Comparison Table ---")
    print("| Scale | ChromaDB (self-hosted) | Pinecone (s1.x1) | Weaviate Cloud | Notes |")
    print("| :--- | :--- | :--- | :--- | :--- |")
    print("| **100K vectors** | $10/mo | $70/mo | $25/mo | Chroma runs on basic VPS; Pinecone requires 1 pod minimum; Weaviate standard base tier. |")
    print("| **1M vectors** | $10/mo | $70/mo | $25/mo | Chroma easily fits in memory on 4GB VPS; Pinecone 1 pod; Weaviate standard base tier. |")
    print("| **10M vectors** | $20/mo (upgrade VPS) | $140/mo (2 pods) | $185/mo | Chroma upgraded to 8GB VPS ($20/mo); Pinecone requires 2 pods; Weaviate standard tier scales up. |")
